 ...
 */
final class Version20260504111631 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tarea (id INT AUTO_INCREMENT NOT NULL, titulo VARCHAR(255) NOT NULL, descripcion LONGTEXT DEFAULT NULL, estado VARCHAR(50) NOT NULL, fecha_limite DATETIME NOT NULL, prioridad INT NOT NULL, propietario_id INT NOT NULL, INDEX IDX_3CA0536653C8D32C (propietario_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
