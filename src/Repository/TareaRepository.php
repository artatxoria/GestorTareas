...
class TareaRepository
{
    ...
    public function findAll(): array
    {
       ...
       return [
            ...
            new Tarea(4,  'Llamar al proveedor de hosting',   'Negociar renovación del contrato anual',                       TareaEstadoEnum::PENDIENTE,   new \DateTimeImmutable('2026-04-08'), 7, $getUsuario(3)),
            ...
            new Tarea(7,  'Redactar política de privacidad',  'Adaptarla al nuevo reglamento europeo de protección de datos', TareaEstadoEnum::PENDIENTE,   new \DateTimeImmutable('2026-04-01'), 8, $getUsuario(6)),
